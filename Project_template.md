...
Вопросы на известные темы:
1. Кто такой Kael?
2. Как звали брата Kael?
3. Как звали отца Kael и Rovan?
4. Какими способами умирал Kael?
5. С чего начинается завязка?
6. Что означает имя Kael?

Вопросы на удаленные темы:
1. Кто такой Rovan?
2. Где родился Kael?
3. Какого цвета Vanguard?
4. Что такое Vanguard?

#### Скрипт проверки:

Основан на использование косинусного сходства эмбеддингов
...
Оценка качества: 2.3 из 5.0.

2. Какие темы плохо покрыты (Gap Analysis)

Отсутствие иерархии: Бот фокусируется на второстепенных деталях ("страх летать"), игнорируя фундаментальную роль персонажа в лоре ("хранитель", "Люди Письма").

3. Сколько «пробелов» выявлено

На основе теста можно выделить 3 критических пробела:
Пробел точности (Accuracy Gap): Модель делает выводы на основе "шумных" данных, которые не являются сутью ответа.
Пробел полноты (Completeness Gap): Индекс базы знаний, вероятно, не содержит связного определения "Кто такой Kael", заставляя LLM собирать образ по кусочкам.

4. Рекомендации по улучшению базы знаний

    1. Очистить базу от мусора, логов и черновиков
    2. Добавить метаданные к чанкам
    3. Корректировка системного промпта
